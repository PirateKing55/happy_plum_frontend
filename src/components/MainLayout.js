...
import { FaBars, FaBell, FaEnvelope, FaUser, FaCar, FaUsers, FaBook, FaCaretDown, FaTachometerAlt, FaDog, FaChevronUp, FaChevronDown, FaBuilding, FaClipboardCheck, FaComment, FaPlus, FaCalendarPlus, FaPen, FaDatabase, FaFileAlt, FaEye, FaChartLine, FaBookOpen, FaRoute, FaLightbulb, FaCog, FaGraduationCap, FaFileArchive, FaPencilAlt, FaMountain, FaGamepad, FaHandshake, FaStar, FaClipboardList, FaRobot, FaCheckSquare, FaFilter, FaTheaterMasks, FaBookmark, FaFolder, FaBullseye, FaGlobe, FaFile, FaListAlt, FaSitemap, FaCommentDots, FaTrophy, FaMapMarker, FaCalendarAlt, FaPaperPlane, FaLifeRing, FaHeadset, FaUserCheck, FaChartBar, FaTasks, FaThumbsUp, FaHandPaper, FaHandPointDown, FaEllipsisV } from "react-icons/fa";
  ...
  return (<>
    ...
    <Navbar expand="lg" fixed="top" className="w-100" style={{ backgroundColor: "#7335b7" }}>
      <Container fluid>
        ...
        <Button variant="primary" onClick={handleToggle} className="me-2 bg-info">
          <FaBars />
        </Button>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Navbar.Brand href="#" className="text-light d-flex align-items-center">
            <span>Hi! Welcome </span><strong className="px-2"> {user?.fullName}</strong>
          </Navbar.Brand>
          <Nav className="ms-auto">
            ...
            <Nav.Link href="#">
              ...
              <Badge pill className="d-inline-flex align-items-center">
                <Image src={Logo} alt="" roundedCircle className="mr-2 mb-0" width={30} height={30} />
            ...
            <NavDropdown title={<>
              <Badge pill className="d-inline-flex align-items-center">
                <h1 roundedCircle className="mr-2 py-2" width={30} height={30} />
                <FaCog />

                Settings
              </Badge> </>} id="collasible-nav-dropdown" align="end">
    ...
    <div className="d-flex h-100 py-5">
      ...
      <div className={`sidebar text-white ${open ? 'open' : 'closed'} `} style={{ backgroundColor: "#7335b7", minHeight: "100vh", width: `${open ? '22%' : '2%'}` }}>
        ...
        <Nav className="flex-column py-3" style={{ position: "fixed" }}>
          ...
          {types?.type === "Student" ? (<>
            <Nav.Item>
              ...
              <Nav.Link onClick={() => navigate("/dashboard/homework")} className="text-white d-flex align-items-center">
                <FaBook className="me-2" />
                {open && "Homework"}
              </Nav.Link>

              <Nav.Link onClick={() => navigate("/dashboard/rubric")} className="text-white d-flex align-items-center">
                <FaCheckSquare className="me-2" />
                {open && "Rubric"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/real-life-scenario")} className="text-white d-flex align-items-center">
                <FaGlobe className="me-2" />
                {open && "Real Life Scenario"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/lessons")} className="text-white d-flex align-items-center">
                <FaBookOpen className="me-2" />
                {open && "Lessons"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/goal")} className="text-white d-flex align-items-center">
                <FaBullseye className="me-2" />
                {open && "Goal"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/review-sheet")} className="text-white d-flex align-items-center">
                <FaStar className="me-2" />
                {open && "Review Sheet"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/cultural-highlights")} className="text-white d-flex align-items-center">
                <FaTheaterMasks className="me-2" />
                {open && "Cultural Highlights"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/flash-cards")} className="text-white d-flex align-items-center">
                <FaBookmark className="me-2" />
                {open && "Flash cards"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/Test-assessments")} className="text-white d-flex align-items-center">
                <FaClipboardCheck className="me-2" />
                {open && "Test/Assessment"}
              </Nav.Link>
              <Nav.Link onClick={() => navigate("/dashboard/project")} className="text-white d-flex align-items-center">
            ...
            : types?.type === "Teacher" ?
              ...
              (<Nav.Item>
                ...
                <Nav.Link onClick={handleToggle1} className="text-white d-flex align-items-center">
                  ...
                  {open && <>{"Classes"} {open1 ? <FaChevronUp /> : <FaChevronDown />}</>}
                </Nav.Link>
                <Collapse in={open1}>
                  <div className="px-2">
                ...
                <Nav.Link onClick={handleToggle2} className="text-white d-flex align-items-center">
                  ...
                  {open && <>{"Student"} {open2 ? <FaChevronUp /> : <FaChevronDown />}</>}
                </Nav.Link>
                <Collapse in={open2}>
                  <div className="px-2">
                ...
                <Nav.Link onClick={handleToggle3} className="text-white d-flex align-items-center">
                  ...
                  {open && <>{"Assignments"} {open3 ? <FaChevronUp /> : <FaChevronDown />}</>}
                </Nav.Link>
                <Collapse in={open3}>
                  <div className="px-2">
                ...
                <Nav.Link onClick={handleToggle5} className="text-white d-flex align-items-center">
                  ...
                  {open && <>{"Messages"} {open5 ? <FaChevronUp /> : <FaChevronDown />}</>}
                </Nav.Link>
                <Collapse in={open5}>
                  <div className="px-2">
                ...
                <Nav.Link onClick={handleToggle6} className="text-white d-flex align-items-center">
                  ...
                  {open && <>{"Analytics"} {open6 ? <FaChevronUp /> : <FaChevronDown />}</>}
                </Nav.Link>
                <Collapse in={open6}>
                  <div className="px-2">
              ...
              : types?.type === "Parent" ?
                ...
                (
                  <Nav.Item>
                    ...
                    <Nav.Link onClick={handleToggle1} className="text-white d-flex align-items-center">
                      <FaChartBar className="me-2" onClick={handleToggle} />
                      {open && <>{"Overview and Progress Tracking"} {open1 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open1}>
                      <div className="px-2">
                    ...
                    <Nav.Link onClick={handleToggle2} className="text-white d-flex align-items-center">
                      <FaBookmark className="me-2" onClick={handleToggle} />
                      {open && <>{"Activity & Performance"} {open2 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open2}>
                      <div className="px-2">
                        <Nav.Link onClick={() => navigate("/dashboard/recent-activities")} className="text-white d-flex align-items-center">
                          <FaStar className="me-2" />
                          {"Recent Activities"}
                        </Nav.Link>
                        <Nav.Link onClick={() => navigate("/dashboard/performance-metrics")} className="text-white d-flex align-items-center">
                          <FaRoute className="me-2" />
                          {"Performance Metrics"}
                        </Nav.Link>
                        <Nav.Link onClick={() => navigate("/dashboard/skill-breakdown")} className="text-white d-flex align-items-center">
                          <FaRoute className="me-2" />
                          {"Skill Breakdown"}
                        </Nav.Link>
                      </div>
                    ...
                    <Nav.Link onClick={handleToggle3} className="text-white d-flex align-items-center">
                      <FaComment className="me-2" onClick={handleToggle} />
                      {open && <>{"Goal Setting & Monitoring"} {open3 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open3}>
                      <div className="px-2">
                    ...
                    <Nav.Link onClick={handleToggle4} className="text-white d-flex align-items-center">
                      <FaThumbsUp className="me-2" onClick={handleToggle} />
                      {open && <>{"Communication Tools"} {open4 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open4}>
                      <div className="px-2">
                        <Nav.Link onClick={() => navigate("/dashboard/messages-notifications")} className="text-white d-flex align-items-center">
                          <FaTrophy className="me-2" />
                    ...
                    <Nav.Link onClick={handleToggle5} className="text-white d-flex align-items-center">
                      <FaTasks className="me-2" onClick={handleToggle} />
                      {open && <>{"Engagement & Motivation"} {open5 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open5}>
                      <div className="px-2">
                        <Nav.Link onClick={() => navigate("/dashboard/achievements-rewards")} className="text-white d-flex align-items-center">
                          < FaCalendarAlt className="me-2" />
                          {"Achievements & Rewards"}
                        </Nav.Link>
                        <Nav.Link onClick={() => navigate("/dashboard/encouragement-support")} className="text-white d-flex align-items-center">
                          <FaPaperPlane className="me-2" />
                    ...
                    <Nav.Link onClick={handleToggle6} className="text-white d-flex align-items-center">
                      <FaTasks className="me-2" onClick={handleToggle} />
                      {open && <>{"Administrative Tools"} {open5 ? <FaChevronUp /> : <FaChevronDown />}</>}
                    </Nav.Link>
                    <Collapse in={open6}>
                      <div className="px-2">
